/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b560ed47ac347b9974fdae804a668c75)
// Runtime types generated with workerd@1.20260708.1 2026-07-10 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	SITE_NAME: "Edge Links";
	PUBLIC_ORIGIN: " ";
	DASHBOARD_HOST: " ";
	ROOT_REDIRECT_URL: " ";
	LINK_LENGTH: "6";
	ACCOUNT: DurableObjectNamespace<import("./src/index").AccountStore>;
	LINKS: DurableObjectNamespace<import("./src/index").LinkStore>;
	RATE_LIMITS: DurableObjectNamespace<import("./src/index").RateLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AccountStore" | "LinkStore" | "RateLimiter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_NAME" | "PUBLIC_ORIGIN" | "DASHBOARD_HOST" | "ROOT_REDIRECT_URL" | "LINK_LENGTH">> {}
}
